...
export class DisputeService {
    ...
    async create(data) {
        const payload = {
            ...
            fraud_amount:         (parseFloat(data.expectedBalance) - parseFloat(data.reportedBalance)).toFixed(2),
...
function normalizeDispute(raw) {
    ...
    return {
        ...
        fraudAmount:     val(raw.fraud_amount),
        transactionDate: val(raw.transaction_date),
